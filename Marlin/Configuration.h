...
#define STRING_CONFIG_H_AUTHOR "Leif Bladt"     // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 160, 188 }
